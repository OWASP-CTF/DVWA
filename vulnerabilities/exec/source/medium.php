...
if( isset( $_POST[ 'Submit' ]  ) ) {
	...
	// Blacklists are always incomplete ('|', '&', '`', '$(...)' and newlines all survived the old one),
	// so validate positively instead: the input has to be a dotted-quad IPv4 address and nothing else.
