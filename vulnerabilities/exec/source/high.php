...
if( isset( $_POST[ 'Submit' ]  ) ) {
	...
	// The old blacklist stripped '| ' (with a trailing space) so a bare '|' walked straight through.
	// Validate positively instead: the input has to be a dotted-quad IPv4 address and nothing else.
