...
if( isset( $_GET[ 'Login' ] ) ) {
	...
	// Check the database using a prepared statement, so the password
	// supplied by the caller can never be parsed as SQL syntax.
	...
	if( $result && mysqli_num_rows( $result ) == 1 ) {
		...
		// Login failed - generic message to avoid username enumeration
