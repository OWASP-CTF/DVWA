...
/*
On medium and impossible, only the admin is allowed to update the data.
*/

if ((dvwaSecurityLevelGet() == "medium" || dvwaSecurityLevelGet() == "impossible") && dvwaCurrentUser() != "admin") {
