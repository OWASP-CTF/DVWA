 ...
 * from the console.
 *
 * The token is therefore generated by the server, kept in the session, and
 * checked here with hash_equals. It is single use, so a captured request
 ...
 * server issued token, which no amount of client side computation can predict.
 */
