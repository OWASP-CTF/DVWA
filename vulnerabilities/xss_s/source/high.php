...
if( isset( $_POST[ 'btnSign' ] ) ) {
	...
	// The name field's regex only stripped things resembling a <script tag,
	// leaving <img onerror=...> and friends to be stored verbatim. Encode
	// both fields for the HTML context the guestbook renders them in.
