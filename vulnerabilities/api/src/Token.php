...
class Token {
	...
	/*
	 * The key used to be the literal "Paintbrush" in this file. It now comes
	 * from the environment, with a key file fallback so a fresh checkout still
	 * runs without a usable secret in the repository.
	 */
