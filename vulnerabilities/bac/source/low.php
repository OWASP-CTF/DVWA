...
// Get current user's ID. Bound as a parameter, not concatenated, even
// though dvwaCurrentUser() is server-derived - keep every query in this
// file built the same safe way.
...
if (isset($_GET['action']) && isset($_GET['user_id'])) {
    if (!preg_match('/^\d+$/', $_GET['user_id'])) {
        ...
        try {
            ...
            // into this INSERT - a SQL injection reachable without ever
            // owning a target profile. Bind it as a parameter instead.
