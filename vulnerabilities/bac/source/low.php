...
// This level decided access from the user_id cookie, and displayed the role
// from a user_role cookie. Both are set by the client, so any user could
// read any profile by editing them (IDOR).
