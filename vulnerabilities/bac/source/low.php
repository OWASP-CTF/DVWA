...
// Access control is decided from the session's user, never from request input
$html = "";
...
// Show current user's role for context, taken from the database not from a cookie
$role = ($role === 'admin') ? 'admin' : 'regular_user';
