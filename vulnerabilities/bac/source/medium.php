...
// Get current user's ID with a prepared statement - this is the only
// trustworthy source of "who is asking".
...
// Fixed access control: a hardcoded, guessable token ("user_token") used to
// grant access to ANY user's profile regardless of who was asking. That
// token check has been removed entirely; authorisation is now decided by
// comparing the requested user_id against the server-resolved identity of
// the logged-in user (current_user_id above), which the client cannot
