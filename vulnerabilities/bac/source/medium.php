...
if (isset($_GET['action']) && isset($_GET['user_id'])) {
    if (!preg_match('/^\d+$/', $_GET['user_id'])) {
        ...
        // The old gate was a fixed string, "token=user_token", handed to
        // everyone in the page source. A shared constant is not an
        // authorisation decision -- compare against the id this session
        // actually owns.
        if (!$user_exists) {
