...
// This level accepted a fixed literal, token=user_token, as proof of
// authorisation, and the answer was written in an HTML comment on the
// page. A shared constant is not an authorisation check.
