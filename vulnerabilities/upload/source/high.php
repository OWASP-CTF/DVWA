...
if( isset( $_POST[ 'Upload' ] ) ) {
	...
	// getimagesize() alone only proves the file STARTS like an image - a polyglot passes it.
	// It is used here to establish the real type, and the image is re-encoded below so any
	// appended PHP payload is destroyed rather than stored.
