...
if( !@($GLOBALS["___mysqli_ston"] = mysqli_connect( $_DVWA[ 'db_server' ],  $_DVWA[ 'db_user' ],  $_DVWA[ 'db_password' ], "", $_DVWA[ 'db_port' ] )) ) {
	dvwaMessagePushHtml( "Could not connect to the database service.<br />Please check the config file.<br />Database Error #" . htmlspecialchars( (string) mysqli_connect_errno(), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) . ": " . htmlspecialchars( mysqli_connect_error(), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) . "." );
...
if( !@mysqli_query($GLOBALS["___mysqli_ston"],  $drop_db ) ) {
	dvwaMessagePushHtml( "Could not drop existing database<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
	dvwaPageReload();
}

$create_db = "CREATE DATABASE {$_DVWA[ 'db_database' ]};";
if( !@mysqli_query($GLOBALS["___mysqli_ston"],  $create_db ) ) {
	dvwaMessagePushHtml( "Could not create database<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
	dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"],  $create_tb ) ) {
	dvwaMessagePushHtml( "Table could not be created<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
	dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"],  $insert ) ) {
	dvwaMessagePushHtml( "Data could not be inserted into 'users' table<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
	dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $alter_users) ) {
    dvwaMessagePushHtml( "Could not add role column to users table<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
    dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $update_admin) ) {
    dvwaMessagePushHtml( "Could not set admin role<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
    dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $create_access_log) ) {
    dvwaMessagePushHtml( "Could not create access_log table<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
    dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $create_security_log) ) {
    dvwaMessagePushHtml( "Could not create security_log table<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
    dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $insert) ) {
    dvwaMessagePushHtml( "Data could not be inserted into 'guestbook' table<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
    dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $alter_users_dept) ) {
    dvwaMessagePushHtml( "Could not add account_enabled column to users table<br />SQL: " . htmlspecialchars( ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ) );
    dvwaPageReload();
}
dvwaMessagePush( "Added account_enabled columns to users table." );

// Done
dvwaMessagePushHtml( "<em>Setup successful</em>!" );

if( !dvwaIsLoggedIn())
    dvwaMessagePushHtml( "Please <a href='login.php'>login</a>.<script>setTimeout(function(){window.location.href='login.php'},5000);</script>" );
dvwaPageReload();
